...
try {
    ...
    $arFilter = array("IBLOCK_ID" => [206, 208]);
    ...
    while ($ob = $res->GetNextElement()) {
        ...
        } else if (($arPropPosition['LIST_POSITION']['VALUE'] === 'Снизу' || $arPropPosition['LIST_POSITION']['VALUE'] === 'По центру') && !empty($arFields['PREVIEW_PICTURE'])) {
            CIBlockElement::SetPropertyValueCode(
                $arFields['ID'],
                'ICON_TILE',
