        ...
        <div class="d-flex flex-column row-gap-4 row-gap-md-6 row-gap-lg-7">
            ...
            <div class="d-flex flex-column row-gap-4">
                <div class="d-flex flex-column row-gap-4 row-gap-lg-6">
                    <div class="d-flex flex-column row-gap-2 js-select-borrower-type-wrapper">
                        <label class="form-label mb-0"
                               for="select-loan-borrower">Тип заемщика</label>
                        <select class="form-select js-select js-select-borrower-type"
                                id="select-loan-borrower" aria-label="Подсказка">
                            <option selected value="Зарплатный клиент">
                                Зарплатный клиент
                            </option>
                        </select>
                    </div>
