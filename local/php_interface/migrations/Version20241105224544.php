...
class Version20241105224544 extends Version
{
    protected $author = "votincev-aa@galagodigital.ru";

    protected $description = "Инфоблок для детальных страниц карточек";
  ...
  'HINT' => '',
            ...
            $helper->Iblock()->saveProperty($iblockId, array (
  'NAME' => 'Заголовок блока с вариантами',
  'ACTIVE' => 'Y',
  'SORT' => '500',
  'CODE' => 'OPTIONS_BLOCK_HEADING',
  'DEFAULT_VALUE' => '',
  'PROPERTY_TYPE' => 'S',
  'ROW_COUNT' => '1',
  'COL_COUNT' => '30',
  ...
  'FILE_TYPE' => '',
  'MULTIPLE_CNT' => '5',
  'LINK_IBLOCK_ID' => 'additional:become_customer_ru',
  'WITH_DESCRIPTION' => 'N',
  'SEARCHABLE' => 'N',
  'FILTRABLE' => 'N',
  'IS_REQUIRED' => 'N',
