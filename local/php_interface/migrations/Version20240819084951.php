...
class Version20240819084951 extends Version
{
    protected $author = "votincev-aa@galagodigital.ru";

    protected $description = "Инфоблок Главный слайдер";
  ...
  'ELEMENT_ADD' => 'Добавить слайд',
  'ELEMENT_EDIT' => 'Изменить слайд',
  'ELEMENT_DELETE' => 'Удалить слайд',
  ...
  array (
    ...
    'SORT' => 'Сортировка',
    'NAME' => 'Название',
    'PROPERTY_TEXT' => 'Текст слайда',
    'edit1_csection1' => 'Кнопка на слайде',
