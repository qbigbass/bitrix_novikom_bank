...
class Version20240816094427 extends Version
{
  ...
  array (
    ...
    array (
      ...
      'DEF' => 'N',
      'SORT' => '500',
      'XML_ID' => '2a9a8fe99c014a847db901598ba1071a',
    ),
  ),
  'FEATURES' => 
  array (
  ...
  array (
    ...
    array (
      ...
      'DEF' => 'N',
      'SORT' => '500',
      'XML_ID' => 'e99c766d7e8ac57522d3de0fdc858c28',
    ),
  ),
  'FEATURES' => 
  array (
    ...
    array (
      ...
      'IS_ENABLED' => 'N',
            ...
            $helper->Iblock()->saveProperty($iblockId, array (
  'NAME' => 'Пошаговая визуализация получения',
  'ACTIVE' => 'Y',
  'SORT' => '500',
  'CODE' => 'VISUALIZATION',
  'DEFAULT_VALUE' => '',
  ...
  'HINT' => '',
            ...
            $helper->Iblock()->saveProperty($iblockId, array (
  'NAME' => 'Вопрос и ответы по кредитам',
  'ACTIVE' => 'Y',
  'SORT' => '500',
  'CODE' => 'QA_SECTION',
  'DEFAULT_VALUE' => '',
