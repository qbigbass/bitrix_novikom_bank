...
class Version20241205100721 extends Version
{
  ...
  'CODE' => 'fi_strategies',
  'API_CODE' => 'fiStrategiesApi',
  'REST_ON' => 'N',
  'NAME' => 'Стратегии для каталога услуг',
  'ACTIVE' => 'Y',
  'SORT' => '500',
  'LIST_PAGE_URL' => '',
  'DETAIL_PAGE_URL' => '',
  ...
  array (
    ...
    array (
      ...
      'IS_ENABLED' => 'N',
            ...
            $helper->Iblock()->saveProperty($iblockId, array (
  'NAME' => 'Динамика среднемесячной доходности (файл)',
  'ACTIVE' => 'Y',
  'SORT' => '500',
  'CODE' => 'FILE',
  'DEFAULT_VALUE' => '',
  ...
  'HINT' => '',
            ...
            $helper->Iblock()->saveProperty($iblockId, array (
  'NAME' => 'Ожидаемая доходность, в год',
  'ACTIVE' => 'Y',
  'SORT' => '500',
  'CODE' => 'PROFIT',
  'DEFAULT_VALUE' => '',
  ...
  array (
    ...
    'PROPERTY_TYPE' => 'Тип стратегии',
    'PROPERTY_RISK' => 'Риск',
    'PROPERTY_PERIOD' => 'Срок инвестирования',
    'PROPERTY_PROFIT' => 'Ожидаемая доходность',
    'PROPERTY_FILE' => 'Динамика среднемесячной доходности (файл)',
    'PROPERTY_TARGET' => 'Цель',
    'PROPERTY_CONTROL_METHOD' => 'Способ управления',
    'PROPERTY_REQUIREMENTS' => 'Требования к инвестору',
    'PROPERTY_RATES' => 'Ставки комиссий',
