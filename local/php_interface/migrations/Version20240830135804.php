...
class Version20240830135804 extends Version
{
    protected $author = "aleksey.sidyagin@dalee.ru";

    protected $description = "Создает новый ИБ \"Как оформить карту\"";
