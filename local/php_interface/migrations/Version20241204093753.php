...
class Version20241204093753 extends Version
{
    protected $author = "r.machmutov@astarus.ru";

    protected $description = "ИБ Финансовым институтам / Контент для аккордиона для каталога услуг";
  ...
  'CODE' => 'fi_accordion',
  'API_CODE' => 'fiAccordionApi',
  'REST_ON' => 'N',
  'NAME' => 'Контент для аккордиона для каталога услуг',
  'ACTIVE' => 'Y',
  'SORT' => '500',
  'LIST_PAGE_URL' => '',
  'DETAIL_PAGE_URL' => '',
