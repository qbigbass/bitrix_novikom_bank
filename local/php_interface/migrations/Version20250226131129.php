...
class Version20250226131129 extends Version
{
    protected $author = "andreyweb110@mail.ru";

    protected $description = "Переименование Табов и Бенефитов в инфоблоке Кредиты";
  ...
  'FILTER_HINT' => '',
            ...
            $helper->Iblock()->saveProperty($iblockId, array (
  'NAME' => 'Текст кнопки текстового блока',
  'ACTIVE' => 'Y',
  'SORT' => '1500',
  'CODE' => 'TEXT_BLOCK_BUTTON',
  'DEFAULT_VALUE' => '',
  'PROPERTY_TYPE' => 'S',
  'ROW_COUNT' => '1',
  'COL_COUNT' => '30',
  ...
  'FILTER_HINT' => '',
            ...
            $helper->Iblock()->saveProperty($iblockId, array (
  'NAME' => 'Ссылка кнопки текстового блока',
  'ACTIVE' => 'Y',
  'SORT' => '1600',
  'CODE' => 'TEXT_BLOCK_BUTTON_LINK',
  'DEFAULT_VALUE' => '',
  'PROPERTY_TYPE' => 'S',
  'ROW_COUNT' => '1',
  'COL_COUNT' => '30',
  ...
  'FILTER_HINT' => '',
            ...
            $helper->Iblock()->saveProperty($iblockId, array (
  'NAME' => 'Картинка текстового блока',
  'ACTIVE' => 'Y',
  'SORT' => '1700',
  'CODE' => 'TEXT_BLOCK_IMAGE',
  'DEFAULT_VALUE' => '',
  'PROPERTY_TYPE' => 'F',
  'ROW_COUNT' => '1',
  'COL_COUNT' => '30',
  ...
  array (
    ...
    'cedit2_csection4' => 'Инфоврезка',
    'PROPERTY_QUOTE_HEADER' => 'Заголовок',
    'PROPERTY_QUOTE_TEXT' => 'Текст',
    'cedit2_csection5' => 'Текстовый блок',
