...
class Version20241223164504 extends Version
{
    protected $author = "admin";

    protected $description = "Добавляет ИБ \"Блоки на разводящей\"";
  ...
  'CODE' => 'pb_blocks_index',
  'API_CODE' => NULL,
  'REST_ON' => 'N',
  'NAME' => 'Блоки на разводящей',
  'ACTIVE' => 'Y',
  'SORT' => '500',
  'LIST_PAGE_URL' => '',
  'DETAIL_PAGE_URL' => '',
  ...
  array (
    ...
    'PROPERTY_CONTENT_JSON' => 'Контент в JSON',
  ),
  'Анонс|edit5' =>
  array (
