...
class Version20241107173428 extends Version
{
    protected $author = "votincev-aa@galagodigital.ru";

    protected $description = "Исправляет название инфоблока \"Как стать клиентом\", на \"Инструкции\"";
  ...
  'CODE' => 'instructions_ru',
  'API_CODE' => 'InstructionsRuApi',
  'REST_ON' => 'N',
  'NAME' => 'Инструкции',
  'ACTIVE' => 'Y',
  'SORT' => '500',
  ...
  array (
    ...
    'PROPERTY_LINK_TITLE' => 'Текст ссылки',
