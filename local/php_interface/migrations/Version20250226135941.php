...
class Version20250226135941 extends Version
{
    protected $author = "andreyweb110@mail.ru";

    protected $description = "Переименование Табов и Бенефитов в инфоблоке Платежи и переводы";
  ...
  'CODE' => 'payments_and_transfers',
  'API_CODE' => 'paymentsAndTransfers',
  'REST_ON' => 'N',
  'NAME' => 'Платежи и переводы',
  'ACTIVE' => 'Y',
  'SORT' => '700',
  'LIST_PAGE_URL' => '#SITE_DIR#/payments-and-transfers/',
  'DETAIL_PAGE_URL' => '#SITE_DIR#/payments-and-transfers/#ELEMENT_CODE#/',
  'SECTION_PAGE_URL' => '',
  'CANONICAL_PAGE_URL' => '',
  'PICTURE' => NULL,
  'DESCRIPTION' => '1',
  ...
  array (
    ...
    array (
      ...
      'DEF' => 'N',
      'SORT' => '500',
      'XML_ID' => '6241a979ea1169a3fb49320afb83501b',
    ),
  ),
  'FEATURES' => 
  array (
  ...
  array (
    ...
    array (
      ...
      'DEF' => 'N',
      'SORT' => '500',
      'XML_ID' => 'c8af60a0adacd82d1fd096702ad00d46',
    ),
  ),
  'FEATURES' => 
  array (
  ...
  array (
    ...
    array (
      ...
      'IS_ENABLED' => 'N',
            ...
            $helper->Iblock()->saveProperty($iblockId, array (
  'NAME' => 'Заголовок инструкций',
  'ACTIVE' => 'Y',
  'SORT' => '900',
  'CODE' => 'CARD_RECEIPT_OPTIONS_HEADER',
  'DEFAULT_VALUE' => '',
  'PROPERTY_TYPE' => 'S',
  'ROW_COUNT' => '1',
  'COL_COUNT' => '30',
  ...
  array (
    ...
    'PROPERTY_BANNER_TEMPLATE' => 'Шапка на детальной',
    'PROPERTY_BANNER_IMAGE' => 'Детальная картинка',
    'PROPERTY_BANNER_BACKGROUND' => 'Бэграунд',
