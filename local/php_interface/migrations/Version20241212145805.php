...
class Version20241212145805 extends Version
{
    protected $author = "r.machmutov@astarus.ru";

    protected $description = "ИБ \"МСБ / Подробная информация об услугах для каталога услуг\"";
  ...
  'CODE' => 'msb_full_info_services',
  'API_CODE' => 'msvFullInfoServicesApi',
  'REST_ON' => 'N',
  'NAME' => 'Подробная информация об услугах для каталога услуг',
  'ACTIVE' => 'Y',
  'SORT' => '500',
  'LIST_PAGE_URL' => '',
  'DETAIL_PAGE_URL' => '',
  ...
  'NAME' => 'Связь с разделом каталога услуг',
  'ACTIVE' => 'Y',
  'SORT' => '500',
  'CODE' => 'RELATION_CATALOG',
  'DEFAULT_VALUE' => '',
  'PROPERTY_TYPE' => 'G',
  'ROW_COUNT' => '1',
  'COL_COUNT' => '30',
  ...
  array (
    ...
    array (
      ...
      'IS_ENABLED' => 'N',
            ...
            $helper->Iblock()->saveProperty($iblockId, array (
  'NAME' => 'Содержимое для таба "Тарифы"',
  'ACTIVE' => 'Y',
  'SORT' => '500',
  'CODE' => 'TAB_TARIF',
  'DEFAULT_VALUE' => '',
  ...
  array (
    ...
    array (
      ...
      'IS_ENABLED' => 'N',
            ...
            $helper->Iblock()->saveProperty($iblockId, array (
  'NAME' => 'Файлы для таба "Документы и тарифы"',
  'ACTIVE' => 'Y',
  'SORT' => '500',
  'CODE' => 'DOCUMENTS',
  'DEFAULT_VALUE' => '',
  ...
  array (
    ...
    array (
      ...
      'IS_ENABLED' => 'N',
            ...
            $helper->Iblock()->saveProperty($iblockId, array (
  'NAME' => 'Населенный пункт для таба "Фонды"',
  'ACTIVE' => 'Y',
  'SORT' => '500',
  'CODE' => 'TAB_FUNDS_CITY',
  'DEFAULT_VALUE' => '',
  ...
  'HINT' => '',
            ...
            $helper->Iblock()->saveProperty($iblockId, array (
  'NAME' => 'Ссылка на страницу фонда для таба "Фонды"',
  'ACTIVE' => 'Y',
  'SORT' => '500',
  'CODE' => 'TAB_FUNDS_LINK',
  'DEFAULT_VALUE' => '',
  ...
  array (
    ...
    'PROPERTY_TAB_FUNDS_CITY' => 'Населенный пункт для таба "Фонды"',
    'PROPERTY_TAB_FUNDS_DESC' => 'Описание для таба "Фонды"',
    'PROPERTY_TAB_FUNDS_LINK' => 'Ссылка на страницу фонда для таба "Фонды"',
    'PROPERTY_RELATION_CATALOG' => 'Связь с разделом каталога услуг',
    'PROPERTY_TAB_TARIF' => 'Содержимое для таба "Тарифы"',
    'PROPERTY_DOCUMENTS' => 'Файлы для таба "Документы и тарифы"',
  ),
  'Анонс|edit5' => 
  array (
  ...
  array (
    ...
    array (
      ...
      array (
        ...
        1 => 'TIMESTAMP_X',
        2 => 'ID',
        3 => 'PROPERTY_TAB_FUNDS_CITY',
        4 => 'PROPERTY_RELATION_CATALOG',
      ),
      'columns_sizes' => 
      array (
        'expand' => 1,
