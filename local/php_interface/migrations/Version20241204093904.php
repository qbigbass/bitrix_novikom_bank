...
class Version20241204093904 extends Version
{
    protected $author = "r.machmutov@astarus.ru";

    protected $description = "ИБ Финансовым институтам / Слайдер с продуктами для каталога услуг";
  ...
  'CODE' => 'fi_sliders_products',
  'API_CODE' => 'fiSlidersProductsApi',
  'REST_ON' => 'N',
  'NAME' => 'Слайдер с продуктами для каталога услуг',
  'ACTIVE' => 'Y',
  'SORT' => '500',
  'LIST_PAGE_URL' => '',
  'DETAIL_PAGE_URL' => '',
