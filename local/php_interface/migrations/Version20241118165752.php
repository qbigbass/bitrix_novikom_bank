...
class Version20241118165752 extends Version
{
    protected $author = "votincev-aa@galagodigital.ru";

    protected $description = "инфоблок банковские карты (витрина)";
  ...
  'CODE' => 'cards_list_ru',
  'API_CODE' => 'CardsListRuApi',
  'REST_ON' => 'N',
  'NAME' => 'Банковские карты (витрина)',
  'ACTIVE' => 'Y',
  'SORT' => '500',
  'LIST_PAGE_URL' => '#SITE_DIR#/cards/',
  'DETAIL_PAGE_URL' => '#SITE_DIR#/cards/#SECTION_CODE#/#ELEMENT_CODE#/',
  'SECTION_PAGE_URL' => '#SITE_DIR#/cards/#SECTION_CODE#/',
  'CANONICAL_PAGE_URL' => '',
  'PICTURE' => NULL,
  'DESCRIPTION' => 'Карты с оптимальными условиями и приятными бонусами',
  ...
  'EDIT_FILE_BEFORE' => '',
  'EDIT_FILE_AFTER' => '',
  'SECTIONS_NAME' => 'Типы карт',
  'SECTION_NAME' => 'Тип карт',
  ...
  'SECTION_ADD' => 'Добавить тип карт',
  'SECTION_EDIT' => 'Изменить тип карт',
  'SECTION_DELETE' => 'Удалить тип карт',
));
  ...
  'FILTER_HINT' => '',
            ...
            $helper->Iblock()->saveProperty($iblockId, array (
  'NAME' => 'Раздел с детальными страницами',
  'ACTIVE' => 'Y',
  'SORT' => '500',
  'CODE' => 'DETAIL_PAGES',
  'DEFAULT_VALUE' => '',
  ...
  'FILE_TYPE' => '',
  'MULTIPLE_CNT' => '5',
  'LINK_IBLOCK_ID' => 'for_private_clients_ru:cards_detail_pages_ru',
  'WITH_DESCRIPTION' => 'N',
  'SEARCHABLE' => 'N',
  'FILTRABLE' => 'N',
  'IS_REQUIRED' => 'N',
  ...
  'FILTER_HINT' => '',
            ...
            $helper->Iblock()->saveProperty($iblockId, array (
  'NAME' => 'Выводить кнопку "Оформить заявку"',
  'ACTIVE' => 'Y',
  'SORT' => '500',
  'CODE' => 'SHOW_BUTTON',
  'DEFAULT_VALUE' => '',
  ...
  array (
    ...
    array (
      ...
      'DEF' => 'N',
      'SORT' => '500',
      'XML_ID' => 'cde15b66ce16f76252a0a9a3e0e5b156',
    ),
  ),
  'FEATURES' => 
  array (
  ...
  'HINT' => 'Чтобы вывести текст крупным шрифтом, оберните его в квадратные скобки',
  'FEATURES' => 
  array (
    0 => 
    array (
  ...
  'FILTER_HINT' => '',
            ...
            $helper->Iblock()->saveProperty($iblockId, array (
  'NAME' => 'Иконка на детальной странице',
  'ACTIVE' => 'Y',
  'SORT' => '500',
  'CODE' => 'ICON_DETAIL',
  'DEFAULT_VALUE' => '',
  ...
  array (
    ...
    'CODE' => 'Символьный код',
    'SORT' => 'Сортировка',
    'PROPERTY_ICON_PREVIEW' => 'Иконка на витрине',
    'PROPERTY_SHOW_BUTTON' => 'Выводить кнопку "Оформить заявку"',
    'PROPERTY_SHORT_CONDITIONS' => 'Краткие условия',
  ),
  'Детальная информация|cedit1' => 
  array (
    'PROPERTY_ICON_DETAIL' => 'Иконка на детальной странице',
    'PROPERTY_DETAIL_PAGES' => 'Раздел с детальными страницами',
  ),
  'SEO|edit14' => 
  array (
