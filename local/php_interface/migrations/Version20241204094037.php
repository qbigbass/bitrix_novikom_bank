...
class Version20241204094037 extends Version
{
    protected $author = "r.machmutov@astarus.ru";

    protected $description = "ИБ Финансовым институтам / Продукты для каталога услуг";
  ...
  'CODE' => 'fi_products',
  'API_CODE' => 'fiProductsApi',
  'REST_ON' => 'N',
  'NAME' => 'Продукты для каталога услуг',
  'ACTIVE' => 'Y',
  'SORT' => '500',
  'LIST_PAGE_URL' => '',
  'DETAIL_PAGE_URL' => '',
