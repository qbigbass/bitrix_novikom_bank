...
class Version20241204093201 extends Version
{
    protected $author = "r.machmutov@astarus.ru";

    protected $description = "ИБ Финансовым институтам / Блок контакты";
  ...
  array (
    0 => 
    array (
      'VALUE' => 'Межбанковское кредитование (сделки МБК)',
      'DEF' => 'N',
      'SORT' => '500',
      'XML_ID' => '52a3778321bb16debb76b2f59e8c8460',
    ),
  ),
  'FEATURES' => 
  array (
    ...
    array (
      ...
      'IS_ENABLED' => 'N',
            ...
            $helper->Iblock()->saveProperty($iblockId, array (
  'NAME' => 'Добавочный номер телефона',
  'ACTIVE' => 'Y',
  'SORT' => '500',
  'CODE' => 'PHONE_EXT',
  'DEFAULT_VALUE' => '',
  ...
  array (
    ...
    'PROPERTY_PHONE_EXT' => 'Добавочный номер телефона',
