...
class Version20241204093052 extends Version
{
    protected $author = "r.machmutov@astarus.ru";

    protected $description = "ИБ Финансовым институтам / Тарифы и документы";
  ...
  'CODE' => 'fi_tariffs_documents',
  'API_CODE' => 'tariffsDocumentsApi',
  'REST_ON' => 'N',
