...
class Version20240820112832 extends Version
{
    protected $author = "aleksey.sidyagin@dalee.ru";

    protected $description = "Инфоблок Карт";
  ...
  'ACTIVE' => 'Y',
  'SORT' => '500',
  'LIST_PAGE_URL' => '/for-private-clients/cards/',
  'DETAIL_PAGE_URL' => '/for-private-clients/cards/#SECTION_CODE_PATH#/#ELEMENT_CODE#',
  'SECTION_PAGE_URL' => '/for-private-clients/cards/#SECTION_CODE#/',
  'CANONICAL_PAGE_URL' => '',
  'PICTURE' => NULL,
  'DESCRIPTION' => '',
  ...
  'HINT' => '',
            ...
            $helper->Iblock()->saveProperty($iblockId, array (
  'NAME' => 'Рублями по категориям',
  'ACTIVE' => 'Y',
  'SORT' => '500',
  'CODE' => 'PAY_BY_CATEGORY',
  'DEFAULT_VALUE' => '',
  'PROPERTY_TYPE' => 'S',
  'ROW_COUNT' => '1',
  'COL_COUNT' => '30',
  ...
  'HINT' => '',
            ...
            $helper->Iblock()->saveProperty($iblockId, array (
  'NAME' => 'Снятие и внесение наличных',
  'ACTIVE' => 'Y',
  'SORT' => '500',
  'CODE' => 'DEPOSIT',
  'DEFAULT_VALUE' => '',
  ...
  'HINT' => '',
            ...
            $helper->Iblock()->saveProperty($iblockId, array (
  'NAME' => 'Доступ в бизнес-залы',
  'ACTIVE' => 'Y',
  'SORT' => '500',
  'CODE' => 'BUSINESS_LOUNGES',
  'DEFAULT_VALUE' => '',
  'PROPERTY_TYPE' => 'S',
  'ROW_COUNT' => '1',
  'COL_COUNT' => '30',
  ...
  'HINT' => '',
            ...
            $helper->Iblock()->saveProperty($iblockId, array (
  'NAME' => 'Оплата покупок смартфоном',
  'ACTIVE' => 'Y',
  'SORT' => '500',
  'CODE' => 'SMARTPHONE_PAY',
  'DEFAULT_VALUE' => '',
  ...
  array (
    ...
    'PROPERTY_FREE_PERIOD' => 'Беспроцентный период',
    'PROPERTY_BUSINESS_LOUNGES' => 'Доступ в бизнес-залы',
    'PROPERTY_CREDIT_LIMIT' => 'Кредитный лимит',
    'PROPERTY_SERVICE' => 'Обслуживание',
    'PROPERTY_DESCRIPTION' => 'Описание',
    'PROPERTY_INTERESTET' => 'Процент на остаток',
    'PROPERTY_CASHBACK' => 'Рублями или бонусами',
    'PROPERTY_PAY_BY_CATEGORY' => 'Рублями по категориям',
    'PROPERTY_DEPOSIT' => 'Снятие и внесение наличных',
    'PROPERTY_RUBLES_MIR' => 'Рублями от ПС «Мир»',
    'PROPERTY_TOUCH' => 'В одно касание',
    'PROPERTY_SMARTPHONE_PAY' => 'Оплата покупок смартфоном',
  ),
  'Анонс|edit5' => 
  array (
