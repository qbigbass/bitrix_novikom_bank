...
class Version20241111094137 extends Version
{
    protected $author = "votincev-aa@galagodigital.ru";

    protected $description = "Настройки инфоблока бонусные программы";
  ...
  'CODE' => 'bonus_programs_ru',
  'API_CODE' => 'BonusProgramsRuApi',
  'REST_ON' => 'N',
  'NAME' => 'Бонусные программы',
  'ACTIVE' => 'Y',
  'SORT' => '500',
  'LIST_PAGE_URL' => '',
  'DETAIL_PAGE_URL' => '#SITE_DIR#/bonus-programs/#ELEMENT_CODE#/',
  'SECTION_PAGE_URL' => '',
  'CANONICAL_PAGE_URL' => '',
  'PICTURE' => NULL,
  'DESCRIPTION' => '',
  ...
  array (
    ...
    array (
      ...
      'IS_ENABLED' => 'N',
            ...
            $helper->Iblock()->saveProperty($iblockId, array (
  'NAME' => 'Краткое условие',
  'ACTIVE' => 'Y',
  'SORT' => '500',
  'CODE' => 'SHORT_CONDITION',
  'DEFAULT_VALUE' => NULL,
  'PROPERTY_TYPE' => 'S',
  'ROW_COUNT' => '1',
  'COL_COUNT' => '30',
  ...
  'Анонс|edit5' => 
  array (
    'PROPERTY_SHORT_CONDITION' => 'Краткое условие',
  ...
  'Бенефиты|cedit1' => 
  array (
    'PROPERTY_BENEFITS_COL' => 'Количество колонок в бенефитах',
    'PROPERTY_BENEFITS' => 'Бенефиты',
    'PROPERTY_BENEFITS_INFO_BOX' => 'Инфо-врезка в бенефитах',
  ),
  'Бонусный калькулятор|cedit8' => 
  array (
    'PROPERTY_SHOW_BONUSES_CALC' => 'Выводить калькулятор бонусов',
  ),
  'Категории кэшбека|cedit2' => 
  array (
    'PROPERTY_CASHBACK_CATEGORIES' => 'Категории кэшбека',
  ),
  'Инструкция 1|cedit3' => 
  array (
  ...
  'Блок с табами|cedit7' => 
  array (
    'PROPERTY_TABS_HEADING' => 'Заголовок табов',
    'PROPERTY_TABS' => 'Табы',
  ),
  'Инструкция 2|cedit4' => 
  array (
