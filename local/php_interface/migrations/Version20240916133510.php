...
class Version20240916133510 extends Version
{
    protected $author = "votincev-aa@galagodigital.ru";

    protected $description = "Инфоблок Кредиты";
  ...
  'ACTIVE' => 'Y',
  'SORT' => '500',
  'LIST_PAGE_URL' => '#SITE_DIR#/for-private-clients/loans/',
  'DETAIL_PAGE_URL' => '#SITE_DIR#/for-private-clients/loans/#SECTION_CODE#/#ELEMENT_CODE#/',
  'SECTION_PAGE_URL' => '#SITE_DIR#/for-private-clients/loans/#SECTION_CODE#/',
  'CANONICAL_PAGE_URL' => '',
  'PICTURE' => NULL,
  'DESCRIPTION' => '',
  ...
  'EDIT_FILE_BEFORE' => '',
  'EDIT_FILE_AFTER' => '',
  'SECTIONS_NAME' => 'Направления',
  'SECTION_NAME' => 'Направление',
  'ELEMENTS_NAME' => 'Кредиты',
  'ELEMENT_NAME' => 'Кредит',
  'EXTERNAL_ID' => NULL,
  'LANG_DIR' => '/',
  'IPROPERTY_TEMPLATES' => 
  ...
  'ELEMENT_ADD' => 'Добавить кредит',
  'ELEMENT_EDIT' => 'Изменить кредит',
  'ELEMENT_DELETE' => 'Удалить кредит',
  'SECTION_ADD' => 'Добавить направление',
  'SECTION_EDIT' => 'Изменить направление',
  'SECTION_DELETE' => 'Удалить направление',
));
  ...
  'SORT' => '100',
  'CODE' => 'BENEFITS',
  'DEFAULT_VALUE' => '{"version":2,"blocks":[{"block_heading":"","blocks":[],"items":[{"collapsed":false,"benefit_title":"","benefit_description":""}],"name":"my_benefits","settings":{},"layout":"0,0","meta":{},"image":{"file":[],"desc":"","name":"image"}}],"layouts":[{"settings":{},"columns":[{"css":""}]}]}',
  'PROPERTY_TYPE' => 'S',
  'ROW_COUNT' => '1',
  'COL_COUNT' => '30',
  'LIST_TYPE' => 'L',
  ...
  array (
    ...
    array (
      ...
      'IS_ENABLED' => 'N',
            ...
            $helper->Iblock()->saveProperty($iblockId, array (
  'NAME' => 'Анонс кратких условий',
  'ACTIVE' => 'Y',
  'SORT' => '500',
  'CODE' => 'PREVIEW_SHORT_CONDITIONS',
  ...
  array (
    ...
    array (
      ...
      'IS_ENABLED' => 'N',
            ...
            $helper->Iblock()->saveProperty($iblockId, array (
  'NAME' => 'Краткие условия на детальной странице',
  'ACTIVE' => 'Y',
  'SORT' => '500',
  'CODE' => 'DETAIL_SHORT_CONDITIONS',
  'DEFAULT_VALUE' => '{"version":2,"blocks":[{"small_text":"","main_text":"","condition_name":"","name":"my_loan_condition","settings":{},"layout":"0,0","meta":{}},{"small_text":"","main_text":"","condition_name":"","name":"my_loan_condition","settings":{},"layout":"0,0","meta":{}},{"small_text":"","main_text":"","condition_name":"","name":"my_loan_condition","settings":{},"layout":"0,0","meta":{}}],"layouts":[{"settings":{},"columns":[{"css":""}]}]}',
  'PROPERTY_TYPE' => 'S',
  'ROW_COUNT' => '1',
  'COL_COUNT' => '30',
  ...
  array (
    ...
    array (
      ...
      'IS_ENABLED' => 'N',
            ...
            $helper->Iblock()->saveProperty($iblockId, array (
  'NAME' => 'Условия кредитования',
  'ACTIVE' => 'Y',
  'SORT' => '500',
  'CODE' => 'LOAN_CONDITIONS',
  'DEFAULT_VALUE' => '{"version":2,"blocks":[{"items":[],"name":"my_block_with_tabs","settings":{},"layout":"0,0","meta":{}}],"layouts":[{"settings":{},"columns":[{"css":""}]}]}',
  'PROPERTY_TYPE' => 'S',
  'ROW_COUNT' => '1',
  'COL_COUNT' => '30',
  'LIST_TYPE' => 'L',
  ...
  'SORT' => '500',
  'CODE' => 'HINT',
  'DEFAULT_VALUE' => '{"version":2,"blocks":[{"value":"","name":"my_hint","settings":{},"layout":"0,0","meta":{}}],"layouts":[{"settings":{},"columns":[{"css":""}]}]}',
  'PROPERTY_TYPE' => 'S',
  'ROW_COUNT' => '1',
  'COL_COUNT' => '30',
  'LIST_TYPE' => 'L',
  ...
  array (
    ...
    array (
      ...
      'IS_ENABLED' => 'N',
            ...
            $helper->Iblock()->saveProperty($iblockId, array (
  'NAME' => 'Выводить кнопку для оформления кредита',
  'ACTIVE' => 'Y',
  'SORT' => '500',
  'CODE' => 'IS_BUTTON_SHOW',
  'DEFAULT_VALUE' => '',
  ...
  array (
    ...
    array (
      ...
      'DEF' => 'N',
      'SORT' => '500',
      'XML_ID' => '40b0eb96ecfd404e17d519af644513b1',
    ),
  ),
  'FEATURES' => 
  array (
  ...
  array (
    ...
    'PROPERTY_PREVIEW_SHORT_CONDITIONS' => 'Анонс условий',
  ),
  'Главный баннер|edit6' => 
  array (
    'DETAIL_TEXT' => 'Детальное описание',
    'PROPERTY_DETAIL_SHORT_CONDITIONS' => 'Краткие условия на детальной странице',
    'edit6_csection1' => 'Кнопка на баннере',
    'PROPERTY_IS_BUTTON_SHOW' => 'Выводить кнопку для оформления кредита',
  ),
  'Бенефиты|cedit1' => 
  array (
  ...
  'Подсказка|cedit2' => 
  array (
    'PROPERTY_HINT' => 'Подсказка',
    'PROPERTY_40' => 'Данные для калькулятора',
  ),
  'Баннер|cedit4' => 
  array (
    'PROPERTY_BANNER' => 'Баннер',
  ),
  'Условия кредитования|cedit3' => 
  array (
    'PROPERTY_LOAN_CONDITIONS' => 'Условия кредитования',
  ),
));
  ...
  array (
    ...
    'DATE_CREATE' => 'Создан',
    'TIMESTAMP_X' => 'Изменен',
    'ACTIVE' => 'Направление активно',
    'IBLOCK_SECTION_ID' => 'Родительское направление',
    'NAME' => 'Название',
    'CODE' => 'Символьный код',
  ),
  'SEO|edit5' => 
