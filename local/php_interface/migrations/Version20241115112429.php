...
class Version20241115112429 extends Version
{
    protected $author = "votincev-aa@galagodigital.ru";

    protected $description = "Инфоблок SMS-информирование";
  ...
  'IBLOCK_TYPE_ID' => 'services_ru',
  'LID' => 
  array (
    0 => 's1',
  ),
  'CODE' => 'sms_informirovanie_ru',
  'API_CODE' => 'SmsInfoRuApi',
  'REST_ON' => 'N',
  'NAME' => 'SMS информирование',
  'ACTIVE' => 'Y',
  'SORT' => '500',
  'LIST_PAGE_URL' => '',
  'DETAIL_PAGE_URL' => '#SITE_DIR#/services/#IBLOCK_CODE#/',
  'SECTION_PAGE_URL' => '',
  'CANONICAL_PAGE_URL' => '',
  'PICTURE' => NULL,
  'DESCRIPTION' => '',
  ...
  'Как подключить|cedit2' => 
  array (
    'PROPERTY_INSTRUCTIONS' => 'Как подключить',
  ),
  'Инфо-врезка|cedit3' => 
  array (
    'PROPERTY_ADDITIONAL_INFO' => 'Инфо-врезка',
  ),
  'Табы|cedit4' => 
  array (
    'PROPERTY_TABS' => 'Табы',
