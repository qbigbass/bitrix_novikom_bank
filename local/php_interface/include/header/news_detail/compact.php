...
<section class="banner-text banner-text--border-green <?= $headerColorClass ?>">
        ...
        <div class="row ps-lg-6">
            <div class="col-12 col-sm-6 col-md-8 position-relative z-1 mb-5 mb-md-0 pt-6">
                <div class="d-flex flex-column align-items-start gap-3 gap-md-4">
                    ...
                    <h1 class="banner-text__title dark-0 text-break"><?= $headerH1 ?></h1>
                    <div class="banner-text__description text-l dark-0"><?= $arResult["PREVIEW_TEXT"] ?></div>
                </div>
            </div>
            <div class="d-none d-sm-block col-12 col-sm-6 col-md-4">
                <img class="banner-text__image position-relative w-auto float-end" src="<?= $arResult["DETAIL_PICTURE"]["SRC"] ?>" alt="<?= $arResult["DETAIL_PICTURE"]["ALT"] ?>">
            </div>
        </div>
    </div>
