    ...
    <div class="modal-dialog modal-dialog-scrollable">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="application-form" action="/" method="POST" novalidate id="vacancy-form" data-form>
                    <div class="application-form__step" data-form-validate-group>
                        <div class="d-flex flex-column gap-4 gap-md-5 gap-lg-6">
                            <div class="row g-1 g-md-2 g-lg-2_5">
                                <div class="application-form__col col-12 col-md-6">
                                    <div class="d-flex flex-column row-gap-2">
                                        <label class="form-label mb-0" for="vacancy_lastName">
                                            Фамилия
                                            <span class="orange-100 ms-1">*</span>
                                        </label>
                                        <input class="form-control form-control-lg-lg" id="vacancy_lastName"
                                               type="text" name="lastName" placeholder="Введите фамилию" required
                                ...
                                <div class="application-form__col col-12 col-md-6">
                                    <div class="d-flex flex-column row-gap-2">
                                        <label class="form-label mb-0" for="vacancy_firstName">
                                            Имя и отчество
                                            <span class="orange-100 ms-1">*</span>
                                        </label>
                                        <input class="form-control form-control-lg-lg" id="vacancy_firstName"
                                               type="text" name="firstName" placeholder="Введите имя и отчество"
                                ...
                                <div class="application-form__col col-12 col-md-6">
                                    <div class="d-flex flex-column row-gap-2">
                                        <label class="form-label mb-0" for="vacancy_email">
                                            E-mail
                                            <span class="orange-100 ms-1">*</span>
                                        </label>
                                ...
                                <div class="application-form__col col-12 col-md-6">
                                    <div class="d-flex flex-column row-gap-2">
                                        <label class="form-label mb-0" for="vacancy_phone">
                                            Телефон
                                            <span class="orange-100 ms-1">*</span>
                                        </label>
                                ...
                                <div class="application-form__col col-12">
                                    <div class="upload-file d-flex flex-column row-gap-2" data-upload>
                                        <label class="form-label mb-0" for="vacancy_upload-file">
                                            Прикрепить файлы
                                        </label>
                                        <div class="upload-file__box p-3 p-md-4" data-upload-box>
                                            ...
                                            <button class="btn btn-link btn-icon" type="button" data-upload-button>
                                                <svg class="icon size-m violet-100"
                                                    ...
                                                    <use
                                                        xlink:href="/frontend/dist/img/svg-sprite.svg#icon-attach"></use>
                                                </svg>
                                                Прикрепить
                                            </button>
                                        </div>
                                ...
                                <div class="application-form__col col-12">
                                    <div class="d-flex flex-column row-gap-2">
                                        <label class="form-label mb-0" for="vacancy_cvLink">
                                            Или вставьте ссылку на online-резюме
                                        </label>
                                        <input class="form-control form-control-lg-lg" id="vacancy_cvLink"
                                               type="text" name="cvLink" placeholder="Любое" autocomplete="off"
                                               data-form-input>
                                        <div class="invalid-feedback" aria-live="polite"></div>
                                    </div>
                                </div>
                            ...
                            <div class="form-check">
                                <input class="form-check-input" id="vacancy_confirm" type="checkbox"
                                       name="request_confirm" value="" required data-form-checkbox data-form-input>
                                <label class="form-check-label" for="vacancy_confirm">
                        ...
                        <div
                            class="d-flex flex-column align-items-center flex-md-row row-gap-3 column-gap-6 mt-6 mt-lg-7">
