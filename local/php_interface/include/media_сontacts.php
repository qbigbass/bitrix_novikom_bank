<section class="pt-6 pt-md-9 pt-lg-11">
    <div class="container">
        <div class="row">
            <div class="col-12">
                <div class="card-contact overflow-hidden position-relative bg-linear-blue">
                    <div class="card-contact__content d-flex flex-column gap-4 gap-md-6 gap-lg-11">
                        <h3 class="dark-0 card-contact__top-title">Контакты для СМИ</h3>
                        ...
                        <div class="d-flex flex-column gap-4">
                            ...
                            <div class="card-contact__contacts d-flex flex-column flex-lg-row flex-lg-wrap gap-4">
                                <a
                                    class="card-contact__link dark-0 gap-3" href="mailto:pr@novikom.ru">
                                    <svg class="icon size-m" xmlns="http://www.w3.org/2000/svg" width="100%"
                                         height="100%">
                                        <use xlink:href="img/svg-sprite.svg#icon-mail"></use>
                                    </svg>
                                    <u>pr@novikom.ru</u>
                                </a>
                                <p class="card-contact__link dark-0 mb-0 gap-3" href="mailto:pr@novikom.ru">
                                    <svg class="icon size-m" xmlns="http://www.w3.org/2000/svg" width="100%"
                                         height="100%">
                                        <use xlink:href="img/svg-sprite.svg#icon-phone"></use>
                                    </svg>
                                    <span>
                                ...
                                <a class="card-contact__link w-100 dark-0 gap-3"
                                   href="https://t.me/novikombank_official">
                                    <svg class="icon size-m" xmlns="http://www.w3.org/2000/svg" width="100%"
                                         height="100%">
                                        <use xlink:href="frontend/dist/img/svg-sprite.svg#icon-telegram"></use>
                                    </svg>
                                    <span>
                                        <u>novikombank_official </u>
                                        <span class="d-inline-block text-white-50 w-100 w-lg-auto">Все новости банка Телеграм</span>
                                    </span>
                                </a>
                            </div>
                        </div>
