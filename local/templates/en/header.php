    ...
    <div class="container d-flex justify-content-center align-items-center">
        <div class="settings">
            <div class="fontSizeSettings">
                ...
                <div class="fontSizes">
                    <button class="fontDefault selected" aria-label="Обычный шрифт. Нажмите для выбора" tabindex="0">A
                    </button>
            ...
            <div class="contrastColorSettings">
                ...
                <div class="contrastColors">
                    <button class="contrastColorsBlue" aria-label="Синий цвет сайта. Нажмите для выбора" tabindex="0">
                        A
                    </button>
                    <button class="contrastColorsBlack" aria-label="Чёрный цвет сайта. Нажмите для выбора" tabindex="0">
                        A
                    </button>
                    <button class="contrastColorsYellow" aria-label="Жёлтый цвет сайта. Нажмите для выбора"
                            tabindex="0">A
                    </button>
                </div>
            </div>
            <button class="btnReset" id="hideAccessibilityPanel" aria-label="Обычная версия сайта" tabindex="0">Обычная
                версия сайта<img class="icon" src="/frontend/dist/img/eye.svg" tabindex="0" alt="Иконка глаза"></button>
        </div>
    </div>
</header>
        ...
        <div class="container d-flex align-items-center">
            <div class="header__logo">
                <a class="d-block" href="/en/">
                    <img src="/frontend/dist/img/logo-main-en.svg" width="196" height="56" alt="Novikom">
                </a>
            </div>
            <div class="d-flex flex-column gap-4 ms-auto flex-grow-1">
                <div class="header__top-row">
                    <div class="d-flex align-items-center gap-4 column-gap-xxl-3 column-gap-xxxl-6 ms-auto">
                        <div class="d-none d-lg-flex gap-4 column-gap-xxl-3 column-gap-xxxl-6">
                            <div class="dropdown d-flex">
                                <button class="dropdown-toggle text-s d-inline-flex gap-1 align-items-center dark-100"
                                        type="button" data-bs-toggle="dropdown" aria-expanded="false">Other ways of
                                    communication
                                </button>
                                <div class="dropdown-menu dropdown-menu-end">
                                    <div class="p-3 text-nowrap">
                                        <? $APPLICATION->IncludeFile('/local/php_interface/include/en/ways_of_communication.php'); ?>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="d-flex column-gap-md-3 column-gap-lg-4 column-gap-xxl-3">
                            ...
                            <div class="dropdown">
                                <button class="btn btn-sm btn-primary dropdown-toggle" type="button"
                                        data-bs-toggle="dropdown" aria-expanded="false">Internet bank
                                </button>
                                <ul class="dropdown-menu dropdown-menu-end">
                                    <li><a class="dropdown-item fw-bold" href="https://online.novikom.ru/">For individuals</a></li>
                                    <li><a class="dropdown-item fw-bold" href="https://bk.novikom.ru/ru/html/login.html">For organizations</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
