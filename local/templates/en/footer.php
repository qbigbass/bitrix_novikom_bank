            ...
            <div class="row row-gap-5 footer__content">
                ...
                <div class="col-12 col-md-6 col-xl-3 d-flex flex-column row-gap-3">
                    ...
                    <div class="d-flex flex-column row-gap-3 pt-md-3 pt-lg-5">
                        ...
                        <a class="btn btn-lg-lg btn-outline-primary d-flex gap-2 align-items-center justify-content-center" href="<?=RUSSIAN_VERSION_LINK?>">Russian version</a>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <form>
                        <div class="input-group flex-nowrap js-mobile-search"><span class="input-group-icon" id="input-search-menu"><span class="icon">
                          <svg xmlns="http://www.w3.org/2000/svg" width="100%" height="100%">
                            ...
                            <input class="form-control" type="text" placeholder="Site search" aria-label="Поиск по сайту" aria-describedby="input-search-menu">
                        </div>
                    </form>
                    <div class="mobile-menu__search-content"><span class="dark-70">Popular queries:</span>
                        <div class="d-flex flex-wrap gap-3">
                            <? $APPLICATION->IncludeFile('/local/php_interface/include/en/popular_queries.php'); ?>
                        </div>
                    </div>
                </div>
