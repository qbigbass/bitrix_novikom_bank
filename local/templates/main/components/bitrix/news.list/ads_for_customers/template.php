...
<div class="swiper js-announcement-slider">
    <div class="swiper-wrapper">
        <?foreach ($arResult['ITEMS'] as $arItem): ?>
            ...
            ?>
            <div class="swiper-slide js-announcement-slide" id="<?=$this->GetEditAreaId($arItem['ID']);?>">
                <a class="announcement" href="<?=$arItem['DETAIL_PAGE_URL']?>" tabIndex="-1">
                    <span class="dark-70"><?=$arItem['DISPLAY_PROPERTIES']['DATE']['VALUE']?></span>
