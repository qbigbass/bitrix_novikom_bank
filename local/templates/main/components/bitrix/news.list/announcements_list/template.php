                ...
                foreach ($arResult['ITEMS'] as $item) {?>
                    <div class="search-item d-flex flex-column gap-3 gap-md-4 pb-3 pb-md-4 border-bottom-dashed">
                        <div class="search-item__header">
                            <div class="tag tag--outline"><span class="tag__content text-s fw-semibold"><?= $item['PROPERTIES']['TYPE_AD']['VALUE']?></span><span class="tag__triangle">
                            ...
                            <?endif;?>
                        </div><a class="search-item__content d-flex gap-2 gap-md-3 justify-content-between" href="<?= $item['DETAIL_PAGE_URL']?>">
                            <div class="d-flex flex-column flex-md-row gap-2 gap-md-3"><span class="search-item__date text-m dark-70"><?= $item['PROPERTIES']['DATE']['VALUE']?></span><span class="search-item__name text-m dark-100"><?= $item['NAME']?></span>
                            </div>
