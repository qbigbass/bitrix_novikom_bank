    ...
    foreach ($arResult['SECTIONS_FRAUD_PROTECTION'] as $section) {
        if ($section['CODE'] === 'safety-rules' && !empty($section['ITEMS'])) {?>
            <section class="section-layout px-lg-6">
                <div class="container">
                    <h3 class="mb-4 mb-md-6 mb-lg-7"><?= $section['NAME'] ?></h3>
                    <div class="row row-gap-6 gx-xl-6"><?
                        foreach ($section['ITEMS'] as $item) {?>
                            <div class="col-12 col-md-6 col-lg-4">
                                <div class="benefit d-flex gap-3 flex-column"><img class="icon size-xl" src="<?= $item['ICON'] ?>" alt="icon" loading="lazy">
        ...
        if ($section['CODE'] === 'keep-data-secret' && !empty($section['ITEMS'])) {?>
            <section class="section-layout bg-dark-10">
                <div class="container">
                    <h3 class="mb-4 mb-md-6 mb-lg-7 px-lg-6"><?= $section['NAME'] ?></h3>
                    <div class="row row-gap-4 row-gap-md-5 row-gap-lg-7"><?
                        foreach ($section['ITEMS'] as $item) {?>
                            <div class="col-12 col-md-6 col-xl-3 ps-md-3 ps-lg-3-5"><a class="card-product card-product--transparent card-product--bg-white" href="#">
                                    <div class="card-product__inner">
                                        ...
                                        <div class="card-product__footer"><img class="icon size-xxl ms-auto" src="<?= $item['ICON'] ?>" alt="" loading="lazy">
                                        </div>
                                    </div></a>
                            </div><?
                        }?>
            ...
            <section class="section-layout">
                <div class="container">
                    ...
                    <div class="swiper slider-cards js-slider-cards" data-slides-per-view="mobile-s:1,mobile:1" data-space-between="mobile-s:8,mobile:8" data-slider-breakpoint-destroy="tablet">
                        <div class="swiper-wrapper js-swiper-wrapper g-md-2"><?
                            foreach ($section['ITEMS'] as $item) {?>
