                            ...
                            <? if (!empty($tab['DISPLAY_PROPERTIES'])) {
                                foreach ($tab['DISPLAY_PROPERTIES'] as $property) {
                                    ...
                                    if ($property['CODE'] == 'COMPLEX_PROP' && !empty($property['~VALUE'])) { ?>
                                        <div class="accordion accordion--size-lg accordion--bg-transparent"
                                             id="accordion-insurance-more">
                                            <? foreach ($property['~VALUE'] as $key => $value) { ?>
                                                <div class="accordion-item">
                                                    <div class="accordion-header">
                                                        <button class="accordion-button collapsed" type="button"
                                                                ...
                                                                aria-controls="<?= $key ?>">
                                                            <span
                                                                class="h4"><?= $value['SUB_VALUES']['COMPLEX_HEADER']['~VALUE'] ?></span>
                                                        </button>
                                                    </div>
                                                    <div class="accordion-collapse collapse" id="<?= $key ?>"
                                                            ...
                                                            <div class="d-flex flex-column gap-4 gap-md-5 gap-lg-7">
                                                                <? foreach ($value['SUB_VALUES'] as $subKey => $subValue) {
                                                                    ...
                                                                    if ($subKey == 'COMPLEX_LIST' && !empty($subValue['~VALUE']['TEXT'])) { ?>
                                                                        <div>
                                                                            <div
                                                                                class="text-l fw-semibold mb-3"><?= $value['SUB_VALUES']['COMPLEX_LIST_HEADER']['~VALUE'] ?? '' ?></div>
                                                                            <?= $subValue['~VALUE']['TEXT'] ?>
                                                                        </div>
                                                                    <? }
                                                                    if ($subKey == 'COMPLEX_FILE' && !empty($subValue['VALUE'])) {
                                                                        ...
                                                                        <div>
                                                                            <div
                                                                                class="text-l fw-bold mb-3"><?= $value['SUB_VALUES']['COMPLEX_HEADER_FILE']['~VALUE'] ?? '' ?></div>
                                                                            <div class="link-list">
                                                                                   ...
                                                                                   href="#" download="">
                                                                                    ...
                                                                                    <div
                                                                                        ...
                                                                                        <div
                                                                                            ...
                                                                                            <span
                                                                                                class="document-download__date-time"><?= date('d.m.Y H:i', strtotime($file['TIMESTAMP_X'])) ?> </span>
                                                                                            <span
                                                                                                class="document-download__file-type"><?= mb_strtoupper($fileType) ?></span>
                                                                                        </div>
                                                                                        <span
                                    ...
                                    if (($property['CODE'] == 'CONDITIONS_ICONS' || $property['CODE'] == 'ICONS_WITH_DESCRIPTION') && !empty($property['~VALUE'])) { ?>
                                        <div class="col-12 col-xl-8">
                                            ...
                                            <div class="row row-gap-6">
                                                <? foreach ($property['~VALUE'] as $key => $value) { ?>
                                                    <div
                                                        class="col-12 col-md-6 <?= count($property['~VALUE']) < 3 ? 'col-lg-6' : 'col-lg-4' ?>">
                                                        <div
                                                            class="benefit d-flex gap-3 flex-column flex-md-row align-items-md-center gap-md-4 gap-lg-6">
                                                            <img class="icon size-lxl"
                                                                 src="<?= CFile::GetPath($value) ?>" alt="icon"
                                                                 loading="lazy">
                                            ...
                                            <div class="table-tab__body">
                                                ...
                                                <? foreach ($property['~VALUE'] as $key => $value) { ?>
                                                    <div class="table-tab__row">
                                                        <div
                                                            class="table-tab__cell text-l fw-semibold dark-70"><?= $property['~DESCRIPTION'][$key] ?></div>
                                    ...
                                    if ($property['CODE'] == 'CONDITIONS_TABS' && !empty($property['~VALUE'])) { ?>
                                        <div class="tab-content mt-4 mt-md-6 mt-lg-7">
                                            <div class="tab-pane fade active show" id="limits" aria-labelledby="limits"
                                                            ...
                                                            <div class="table-tab cell-2">
                                                                <div class="table-tab__body">
                                                                    <? foreach ($valueDecoded['DESCRIPTIONS'] as $innerKey => $header) { ?>
                                                                        <div class="table-tab__row">
                                                                            <div
                                                                                class="table-tab__cell text-l fw-semibold dark-70"><?= $header ?></div>
                                        ...
                                        <div class="table-adaptive">
                                            <div class="table-adaptive__header">
                                                <div class="table-adaptive__row">
                                                    <div
                                                        class="table-adaptive__cell text-s"><?= $firstColumnName ?></div>
                                                    <div
                                                        class="table-adaptive__cell text-s"><?= $secondColumnName ?></div>
                                                </div>
                                            </div>
                                                ...
                                                <? foreach ($property['~VALUE'] as $index => $value) { ?>
                                                    <div class="table-adaptive__row">
                                                        <div class="table-adaptive__cell text-number-l fw-bold">
                                                            <span
                                                                class="table-adaptive__label text-s"><?= $firstColumnName ?></span>
                                                            <span><?= $property['DESCRIPTION'][$index] ?></span>
                                                        </div>
                                                        <div class="table-adaptive__cell text-l">
                                                            <span
                                                                class="table-adaptive__label text-s"><?= $secondColumnName ?></span>
                                    ...
                                    if ($property['CODE'] == 'SHORT_INFO' && !empty($property['~VALUE']['TEXT'])) { ?>
                                        ...
                                        <div class="w-100 mt-7 mt-md-7 mt-lg-8">
                                            <div class="polygon-container js-polygon-container">
                                                ...
                                                <div
                                                    class="polygon-container__polygon js-polygon-container-polygon green-100">
                                                    <svg class="js-polygon-container-svg"
                                                         xmlns="http://www.w3.org/2000/svg">
