...
<nav>
    ...
    <ul class="pagination d-none d-md-flex justify-contentstart">
        ...
        if ($arResult["NavPageNomer"] < $arResult["NavPageCount"]):
            ...
            ?><li class="page-item disabled   d-none"><span class="page-link"><?=GetMessage("MAIN_UI_PAGINATION__PREV")?></span></li><?
        endif;
        ...
        if ($arResult["NavPageNomer"] > 1):
            ...
            ?><li class="page-item disabled   d-none"><span class="page-link"><?=GetMessage("MAIN_UI_PAGINATION__NEXT")?></span></li><?
        endif;
        ?></ul><?
    else:
        ?><ul class="pagination pagination-sm">
        <li class="page-item disabled   d-none"><span class="page-link"><?=GetMessage("MAIN_UI_PAGINATION__PAGES")?></span></li><?
        if ($arResult["NavPageNomer"] > 1):
