...
$APPLICATION->IncludeComponent(
    ...
    [
        ...
        "SHOW_AD_INTERNET_BANK" => $arParams["SHOW_AD_INTERNET_BANK"],
        "SHOW_AD_OPEN_ACC_NOVIKOM" => $arParams["SHOW_AD_OPEN_ACC_NOVIKOM"],
    ],
    $component,
    ["HIDE_ICONS" => "Y"]
);
...
$APPLICATION->IncludeComponent(
    ...
    [
        ...
        "SORT_ORDER2" => "ASC",
        "STRICT_SECTION_CHECK" => "N",
        "COLOR_SECTION" => "bg-dark-30",
        "COLOR_CARD" => "contact-block--bg-white",
        "COLOR_TAG" => "tag--outline",
        "COLOR_H4" => "dark-100",
        "COLOR_SPAN" => "dark-100",
        "COLOR_ICON" => "violet-100",
    ],
    false
);
?>
