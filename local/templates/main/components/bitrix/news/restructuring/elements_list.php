...
<!-- Баннер в шапке -->
<section class="text-banner pe-lg-0 px-0 px-lg-6 text-banner--border-green bg-linear-blue">
    <div class="container text-banner__container position-relative z-2">
        <div class="row">
            ...
            <div class="d-none d-sm-block col-12 col-sm-6 col-md-4">
                <img class="text-banner__image position-relative w-auto float-end" src="/frontend/dist/img/big-illustrations/large-individual/restructuring.png" alt="">
            </div>
        </div>
    </div>
