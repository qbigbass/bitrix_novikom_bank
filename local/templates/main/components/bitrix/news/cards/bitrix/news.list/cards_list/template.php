    ...
    <div class="row">
        <div class="col-12 position-relative z-1 d-flex flex-column align-items-start gap-4 gap-md-6 gap-lg-7">
            <?foreach($arResult['ITEMS'] as $arItem) {?>
                ...
                ?>
                <div class="card-product-list overflow-hidden position-relative mh-100 h-auto bg-dark-10 w-100 pt-7 pb-6 py-sm-9 py-md-9 py-lg-11 px-3 px-sm-4 px-md-5 px-lg-6 pe-xxl-11" id="<?=$this->GetEditAreaId($arItem['ID']);?>">
