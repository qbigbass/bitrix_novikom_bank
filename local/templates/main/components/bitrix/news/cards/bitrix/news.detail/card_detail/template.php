    ...
    <div class="banner-product__wrapper">
        <div class="banner-product__content">
            <div class="banner-product__header">
                ...
                <p class="banner-product__subtitle"><?=$arResult['~DETAIL_TEXT']?></p>
            </div>
            <img class="banner-product__image" src="<?=$arResult['SECTION_ICON']?>" alt="" loading="lazy">
        ...
        <div class="container">
            <div class="banner-product-info ps-lg-6">
                    ...
                    <?if(!empty($arResult['DISPLAY_PROPERTIES']['BANNER_TAG']['VALUE'])) : ?>
                        <div class="d-flex flex-row gap-3">
                            <div class="tag tag--outline">
                                <span class="tag__content text-s fw-semibold"><?=$arResult['DISPLAY_PROPERTIES']['BANNER_TAG']['VALUE']?></span>
                ...
                <div class="banner-product-info__body">
                    ...
                    <?if(!empty($arResult['DISPLAY_PROPERTIES']['BANNER_LINK']['VALUE'])) : ?>
                        <a class="btn btn-lg-lg btn-outline-primary fw-bold w-100 w-md-auto mt-6 mt-lg-7" href="<?=$arResult['DISPLAY_PROPERTIES']['BANNER_LINK']['VALUE']?>">Подробнее</a>
                    <?endif;?>
                </div>
...
<?if(
    ...
    <section class="section-restructuring-steps bg-dark-10 py-6 py-sm-9 py-md-11 py-xl-16">
        <div class="container">
            <div class="row px-lg-6">
                <h3 class="d-none d-md-flex"><?=$arResult['DISPLAY_PROPERTIES']['STEPS_HEADER']['~VALUE']?></h3>
...
<?if(!empty($arResult['DISPLAY_PROPERTIES']['CARD_RECEIPT_OPTIONS']['VALUE'])) : ?>
    <section class="section-layout js-collapsed-mobile bg-dark-10">
        <div class="container">
            ...
            <a class="h3 d-flex align-items-center justify-content-between dark-100 d-md-none" data-bs-toggle="collapse" href="#how-apply" role="button" aria-expanded="false" aria-controls="how-apply">
                <?=$arResult['DISPLAY_PROPERTIES']['OPTIONS_BLOCK_HEADING']['~VALUE']?>
                <svg class="icon size-m violet-100" xmlns="http://www.w3.org/2000/svg" width="100%" height="100%">
                    <use xlink:href="/frontend/dist//svg-sprite.svg#icon-chevron-down"></use>
                </svg>
            </a>
