                ...
                <div class="banner-product-info__body">
                    ...
                    <?if(
                        ...
                        <?if($arResult['DISPLAY_PROPERTIES']['LINK_IS_BUTTON']['VALUE'] == 'Y'): ?>
                            <a class="btn btn-lg-lg btn-outline-primary fw-bold w-100 w-md-auto mt-6 mt-lg-7" href="<?=$arResult['DISPLAY_PROPERTIES']['BANNER_LINK']['VALUE']?>">
                                <?=$arResult['DISPLAY_PROPERTIES']['BANNER_LINK_TEXT']['~VALUE']?>
                            </a>
                        <?else: ?>
                            <a class="btn btn-link btn-lg d-inline-flex gap-2 align-items-center mt-6 mt-lg-7" href="<?=$arResult['DISPLAY_PROPERTIES']['BANNER_LINK']['VALUE']?>">
                                <span class="text-m fw-bold"><?=$arResult['DISPLAY_PROPERTIES']['BANNER_LINK_TEXT']['~VALUE']?></span>
