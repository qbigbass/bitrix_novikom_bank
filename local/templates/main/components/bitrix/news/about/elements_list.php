...
<? $iblockDescriptionHtml = ob_get_clean();
...
if (empty($sliders)) {
    $result['PROPERTIES']['HEADER_TEMPLATE']['VALUE_XML_ID'] = 'detailed';
    $result["PROPERTIES"]["HEADER_COLOR_CLASS"]["VALUE"] = 'banner-product--blue';
    $result["DETAIL_PICTURE"]["SRC"] = $iblockPicture;

    $headerView->render(
        $APPLICATION->GetTitle(),
        null,
        ['banner-product banner-product--blue border-0'],
        1,
        $result,
        null,
        $iblockDescriptionHtml,
    );
}
?>
<?
$elementIds = IblockHelper::getIblockSectionElementsIds('ratings');
if (!empty($elementIds)) {
    ...
    $APPLICATION->IncludeComponent(
        ...
        [
            ...
            "FILTER_NAME" => "ratingsFilter",
            "HIDE_LINK_WHEN_NO_DETAIL" => "N",
            "IBLOCK_ID" => iblock('ratings'),
            "IBLOCK_TYPE" => "additional",
            "INCLUDE_IBLOCK_INTO_CHAIN" => "N",
            "INCLUDE_SUBSECTIONS" => "N",
            "MESSAGE_404" => "",
        ...
        <div class="row d-md-none mt-4">
            <div class="col-12">
                <a
                    ...
                    data-bs-toggle="collapse" href="#more-ratifications" role="button" aria-expanded="false"
                    aria-controls="more-ratifications">Показать все
...
<?
$awardsIds = IblockHelper::getIblockSectionElementsIds('awards_ru');
if (!empty($awardsIds)) { ?>
