...
<section class="pt-6 pt-md-9 pt-lg-11">
    <div class="container">
        <div class="row">
            <div class="col-12">
                <? $APPLICATION->IncludeFile('/local/php_interface/include/smi_contacts.php'); ?>
            </div>
        </div>
    </div>
</section>
...
<!-- Табы -->
    <section class="section-catalog__tabs">
        <div class="container">
            <div class="row">
                <div class="col-12 mb-6 mb-md-5 mb-lg-7">
                    <? $APPLICATION->IncludeComponent(
                        ...
                        [
                            ...
                            "COMPONENT_TEMPLATE" => "iblock_elements",
                            "PARENT_DEPTH" => 3
                        ],
                        $component
                    );
