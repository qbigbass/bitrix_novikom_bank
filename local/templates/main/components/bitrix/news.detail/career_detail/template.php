            ...
            <div class="col-12">
                ...
                <div class="d-flex gap-3 gap-md-4 align-items-center">
                    <div class="tag tag--outline tag--triangle-absolute">
                        <span class="tag__content text-s fw-semibold"><?= $arResult['PROPERTIES']['REGION']['VALUE'] ?></span>
                    ...
                    <div class="tag tag--outline tag--triangle-absolute">
                        <span class="tag__content text-s fw-semibold"><?= $arResult['PROPERTIES']['SPECIALIZATION']['VALUE'] ?></span>
                        <span class="tag__triangle">
                            <svg width="14" height="21" viewBox="0 0 14 21" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M13.5 19.3486L0.934259 0.5H13.5V19.3486Z"></path>
                            </svg>
