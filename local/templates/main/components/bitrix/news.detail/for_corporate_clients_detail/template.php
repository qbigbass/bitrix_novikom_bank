...
$headerView->render(
    ...
    null,
    null,
    !empty($arResult['PROPERTIES']['BENEFITS_TOP']['VALUE']) ? renderBenefitsTop($APPLICATION, $arResult['PROPERTIES']['BENEFITS_TOP']['VALUE']) : null
);
?>
    ...
    <section class="section-benefits px-0 px-lg-6 py-6 py-sm-9 py-md-11 py-xl-16 position-relative overflow-hidden">
        <div class="container">
            ...
            <div class="row row-gap-6">
                ...
                $benefitsFilter = [
                    'ACTIVE' => 'Y',
                    'ID' => $arResult['PROPERTIES']['BENEFITS_ICONS']['VALUE']
                ];
        ...
        <div class="container">
            ...
            $APPLICATION->IncludeComponent(
                ...
                [
                    ...
                    "PARENT_SECTION_CODE" => "",
                    "PREVIEW_TRUNCATE_LEN" => "",
                    "PROPERTY_CODE" => ["CONDITIONS_ICONS","CONDITIONS","CONDITIONS_TABS","TEXT_FIELD","SHORT_INFO","QUOTES","QUESTIONS","DOCUMENTS", "BENEFITS", "TEXT_BLOCK_DESCRIPTION", "COMPLEX_PROP"],
                    "SET_BROWSER_TITLE" => "N",
                    "SET_LAST_MODIFIED" => "N",
                    "SET_META_DESCRIPTION" => "N",
                    "SET_META_KEYWORDS" => "N",
...
$APPLICATION->IncludeComponent(
    ...
    [
        ...
        "CACHE_TYPE" => "A",
        "CHECK_DATES" => "Y",
        "DETAIL_URL" => "/for-corporate-clients/customer-announcements/#ELEMENT_CODE#/",
        "DISPLAY_BOTTOM_PAGER" => "N",
        "DISPLAY_TOP_PAGER" => "N",
        "FIELD_CODE" => ["CODE","NAME","PREVIEW_TEXT","PREVIEW_PICTURE",""],
        "FILTER_NAME" => "",
