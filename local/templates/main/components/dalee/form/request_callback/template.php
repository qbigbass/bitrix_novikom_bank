                        ...
                        <div class="row g-1 g-md-2 g-lg-2_5">
                            ...
                            <div class="application-form__col col-12 col-md-6">
                                <div class="d-flex flex-column row-gap-2">
                                    ...
                                    <input class="js-mask-phone form-control form-control-lg-lg" id="callback_phone" type="text" name="PHONE" placeholder="+7" required autocomplete="off" data-form-input>
                                    <div class="invalid-feedback" aria-live="polite"></div>
                                </div>
                            </div>
                            ...
                            <div class="application-form__col col-12">
                                <div class="form-check">
                                    ...
                                    <label class="form-check-label" for="callback_confirm">Подтверждаю согласие на <a href="#">обработку персональных данных</a></label>
