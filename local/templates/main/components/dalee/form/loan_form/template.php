                            ...
                            <div class="row g-1 g-md-2 g-lg-2_5">
                                <div class="application-form__col col-12 col-md-4">
                                    <div class="d-flex flex-column row-gap-2">
                                        ...
                                        <div class="input-group row-gap-2 has-validation">
                                            <input class="form-control form-control-lg-lg" id="loan_employment-history" type="number" name="EMPLOYMENT_HISTORY" placeholder="Кол-во лет" required autocomplete="off" aria-describedby="loan_employment-history-suffix" data-form-input>
                                ...
                                <div class="application-form__col col-12 col-md-4">
                                    <div class="d-flex flex-column row-gap-2">
                                        ...
                                        <div class="input-group row-gap-2 has-validation">
                                            <input class="form-control form-control-lg-lg" id="loan_employment-last-work" type="number" name="EMPLOYMENT_LAST_WORK" placeholder="Кол-во лет" required autocomplete="off" aria-describedby="loan_employment-last-work-suffix" data-form-input>
                        ...
                        <div class="row g-1 g-md-2 g-lg-2_5">
                            ...
                            <div class="application-form__col col-12 col-md-6">
                                <div class="d-flex flex-column row-gap-2">
                                    ...
                                    <div class="input-group row-gap-2 has-validation">
                                        <input class="form-control form-control-lg-lg" id="loan_loan-term" type="number" name="LOAN_TERM" placeholder="Срок" required autocomplete="off" aria-describedby="loan_loan-term-suffix" data-form-input>
                            ...
                            <div class="application-form__col col-12">
                                <div class="form-check">
                                    ...
                                    <label class="form-check-label" for="loan_confirm">Подтверждаю согласие на <a href="#">обработку персональных данных</a></label>
