    ...
    <div class="modal-dialog modal-dialog-scrollable">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Направить обращение</h5>
                ...
                <form class="application-form" action="<?= $arResult['ACTION_URL'] ?>" method="POST" novalidate id="feedback-form" data-form data-form-feedback>
                    ...
                    <div class="application-form__step" data-form-step data-form-validate-group>
                        <div class="row g-1 g-md-2 g-lg-2_5">
                            <div class="application-form__col col-12">
                                <div class="form-step">
                                    <div class="form-step__item text-m fw-semibold"><span>1/2</span><span>Личные данные</span></div>
                            ...
                            <fieldset class="application-form__col col-12">
                                ...
                                <div class="d-flex flex-wrap row-gap-3 row-gap-lg-4 column-gap-6 column-gap-md-5 column-gap-lg-6">
                                    ...
                                    <div class="form-check">
                                        ...
                                        <label class="form-check-label" for="feedback_legal-person">Юридическое лицо или ИП</label>
                                    </div>
                                </div>
                            </fieldset>
                            <div class="application-form__col col-12 col-md-6">
                                <div class="d-flex flex-column row-gap-2">
                                    <label class="form-label mb-0" for="feedback_last-name">Фамилия<span class="orange-100 ms-1">*</span></label>
                                    <input class="form-control form-control-lg-lg" id="feedback_last-name" type="text" name="LAST_NAME" placeholder="Введите фамилию" required autocomplete="off" data-form-input>
                                    <div class="invalid-feedback" aria-live="polite"></div>
                                </div>
                            </div>
                            <div class="application-form__col col-12 col-md-6">
                                <div class="d-flex flex-column row-gap-2">
                                    <label class="form-label mb-0" for="feedback_first-name">Имя<span class="orange-100 ms-1">*</span></label>
                                    <input class="form-control form-control-lg-lg" id="feedback_first-name" type="text" name="FIRST_NAME" placeholder="Введите имя" required autocomplete="off" data-form-input>
                                    <div class="invalid-feedback" aria-live="polite"></div>
                                </div>
                            </div>
                            <div class="application-form__col col-12 col-md-6">
                                <div class="d-flex flex-column row-gap-2">
                                    ...
                                    <input class="form-control form-control-lg-lg" id="feedback_middle-name" type="text" name="MIDDLE_NAME" placeholder="Введите отчество" autocomplete="off" data-form-input>
                                    <div class="invalid-feedback" aria-live="polite"></div>
                                </div>
                            </div>
                            <div class="application-form__col col-12 col-md-6">
                                <div class="d-flex flex-column row-gap-2">
                                    ...
                                    <div class="position-relative">
                                        <input class="js-mask-date form-control form-control-lg-lg js-date js-date--today-max" id="feedback_birthday" type="text" name="BIRTHDAY" placeholder="Укажите дату" autocomplete="off" data-form-input>
                            ...
                            <div class="application-form__col col-12 col-md-6" hidden>
                                <div class="d-flex flex-column row-gap-2">
                                    ...
                                    <input class="form-control form-control-lg-lg" id="feedback_inn" type="text" name="INN" placeholder="Введите ИНН" autocomplete="off" data-form-input>
                                    <div class="invalid-feedback" aria-live="polite"></div>
                                </div>
                            </div>
                            <div class="application-form__col col-12" hidden>
                                <div class="d-flex flex-column row-gap-2">
                                    <label class="form-label mb-0" for="feedback_organization">Наименование организации<span class="orange-100 ms-1">*</span></label>
                                    <input class="form-control form-control-lg-lg" id="feedback_organization" type="text" name="ORGANIZATION" placeholder="Укажите организацию" required autocomplete="off" data-form-input>
                                    <div class="invalid-feedback" aria-live="polite"></div>
                                </div>
                            </div>
                            <div class="application-form__col col-12 col-md-6">
                            ...
                            <div class="application-form__col col-12 col-md-6">
                                <div class="d-flex flex-column row-gap-2">
                                    ...
                                    <input class="js-mask-phone form-control form-control-lg-lg" id="feedback_phone" type="tel" name="PHONE" placeholder="+7" autocomplete="off" data-form-input pattern="\+7\s\(\d{3}\)\s\d{3}-\d{2}-\d{2}" data-error-message="Неверный формат">
                                    <div class="invalid-feedback" aria-live="polite"></div>
                                </div>
                            </div>
                            <fieldset class="application-form__col col-12">
                                ...
                                <div class="d-flex flex-wrap row-gap-3 row-gap-lg-4 column-gap-6 column-gap-md-5 column-gap-lg-6">
                                    ...
                                    <div class="form-check">
                                        ...
                                        <label class="form-check-label" for="feedback_other-email-true">Нет, на иной адрес</label>
                                    </div>
                                </div>
                            </fieldset>
                            <div class="application-form__col col-12" hidden>
                                <div class="d-flex flex-column row-gap-2">
                                    <label class="form-label mb-0" for="feedback_reply-email">Адрес, по которому должен быть направлен ответ (например, адрес электронной почты)<span class="orange-100 ms-1">*</span></label>
                                    <input class="form-control form-control-lg-lg" id="feedback_reply-email" type="email" name="REPLY_EMAIL" placeholder="Введите адрес" required autocomplete="off" data-form-input>
                                    <div class="invalid-feedback" aria-live="polite"></div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="application-form__step" data-form-step data-form-validate-group hidden>
                        <div class="row g-1 g-md-2 g-lg-2_5">
                            <div class="application-form__col col-12">
                                <div class="form-step">
                                    <div class="form-step__item text-m fw-semibold"><span>2/2</span><span>Обращение</span></div>
                            ...
                            <fieldset class="application-form__col col-12">
                                ...
                                <div class="d-flex flex-wrap row-gap-3 row-gap-lg-4 column-gap-6 column-gap-md-5 column-gap-lg-6">
                                    ...
                                    <div class="form-check">
                                        ...
                                        <label class="form-check-label" for="feedback_topic-gratitude">Выразить благодарность</label>
                                    </div>
                                </div>
                            </fieldset>
                            <div class="application-form__col col-12">
                            ...
                            <div class="application-form__col col-12">
                                <div class="d-flex flex-column row-gap-2">
                                    <label class="form-label mb-0" for="undefined_message">Ваше сообщение<span class="orange-100 ms-1">*</span></label>
                                    <textarea class="form-control form-control-lg-lg" id="undefined_message" name="MESSAGE" placeholder="Введите сообщение" required autocomplete="off" data-form-input></textarea>
                                    <div class="invalid-feedback" aria-live="polite"></div>
                                </div>
                            </div>
                            <div class="application-form__col col-12">
