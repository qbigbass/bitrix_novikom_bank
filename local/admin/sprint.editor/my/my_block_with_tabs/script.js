sprint_editor.registerBlock('my_block_with_tabs', function ($, $el, data, settings, currentEditorParams) {
    ...
    var blocklist = [
        {id: 'text', title: 'текст'},
        {id: 'my_list_with_cols', title: 'список с двумя колонками'},
        {id: 'my_loan_calculator', title: 'калькулятор кредитов'},
        {id: 'my_hint', title: 'подсказку'},
        {id: 'my_questions_and_answers', title: 'вопросы и ответы'},
        {id: 'my_documents', title: 'документы'},
    ...
    this.collectData = function () {
        data.items = [];
        data.block_heading = $el.children('.sp-block-heading').val();
    ...
    this.afterRender = function () {
        ...
        function addTab(tabData) {
            var $tab = $(sprint_editor.renderTemplate('my_block_with_tabs-tab', {
                title: tabData.title,
                blocklist: blocklist
            }));
        ...
        function addBlock(blockData, $tabblocks) {
            ...
            var $box = $(sprint_editor.renderTemplate('my_block_with_tabs-box', {
                uid: uid,
