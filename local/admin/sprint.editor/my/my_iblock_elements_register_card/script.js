sprint_editor.registerBlock('my_iblock_elements_register_card', function ($, $el, data, settings) {
    ...
    var sendrequest = function (requestParams, callback) {
        ...
        $.ajax({
            url: sprint_editor.getBlockWebPath('my_iblock_elements_register_card') + '/ajax.php',
            type: 'post',
            data: requestParams,
            dataType: 'json',
            success: function (result) {
                ...
                $jresult.html(
                    sprint_editor.renderTemplate('my_iblock_elements_register_card-select', result)
                );
