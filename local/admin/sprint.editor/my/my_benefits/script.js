sprint_editor.registerBlock('my_benefits', function ($, $el, data, settings, currentEditorParams) {
    ...
    var blocklist = [
        {id: 'my_benefit_item', title: 'бенефит'},
    ];
    ...
    this.afterRender = function () {
        ...
        function addblock(blockData, $container) {
            ...
            var $box = $(sprint_editor.renderTemplate('my_benefits-box', {
                uid: uid,
