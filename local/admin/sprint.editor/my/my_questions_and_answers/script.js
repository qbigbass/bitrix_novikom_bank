sprint_editor.registerBlock('my_questions_and_answers', function ($, $el, data, settings) {

    settings = settings || {
      enabled_iblock: undefined
    };
    ...
    var sendrequest = function (requestParams, callback) {
        ...
        $.ajax({
            url: sprint_editor.getBlockWebPath('my_questions_and_answers') + '/ajax.php',
            type: 'post',
            data: requestParams,
            dataType: 'json',
            success: function (result) {
                ...
                $jresult.html(
                    sprint_editor.renderTemplate('my_questions_and_answers-select', result)
                );
