sprint_editor.registerBlock('my_documents', function ($, $el, data, settings) {
    ...
    var sendrequest = function (requestParams, callback) {
        ...
        $.ajax({
            url: sprint_editor.getBlockWebPath('my_documents') + '/ajax.php',
            type: 'post',
            data: requestParams,
            dataType: 'json',
            success: function (result) {
                ...
                $jresult.html(
                    sprint_editor.renderTemplate('my_documents-select', result)
                );
